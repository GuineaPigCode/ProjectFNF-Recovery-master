...
class PlayState extends MusicBeatState
{
	...
	public var cameraSpeed:Float = 3.5;
	...
	override public function create()
	{
		...
		versionTxt = new FlxText(0, FlxG.height
			- 24, 0, SONG.song
			+ " - "
			+ CoolUtil.difficultyString(false)
			+ " | PFNF "
			+ MainMenuState.projectfnfVersion,
			16);
	...
	override public function update(elapsed:Float)
	{
		...
		if (ClientPrefs.advancedScoreTxt)
		{
			...
			{
				scoreTxt.text = 'Score: ' + songScore + ' | Health: ' + FlxMath.roundDecimal(healthPercentage, 0) + '% | Misses: ' + songMisses + ' | Accuracy: '
					+ FlxMath.roundDecimal(ratingPercent * 100, 2) + '% | ' + fc + ratingString;
			}
		}
		else
		{
			...
			{
				scoreTxt.text = 'Score: ' + songScore + ' | Misses: ' + songMisses + ' | ' + fc + ratingString;
			}
		}
		...
		else if (healthPercentage > 20 && healthPercentage < 80)
			iconP1.animation.curAnim.curFrame = 0;
		else if (healthPercentage > 80 && iconP1.haveWinIcon)
			iconP1.animation.curAnim.curFrame = 2;

		if (healthPercentage < 20 && iconP2.haveWinIcon)
		...
		// TODO: make a option for enable reset
	...
	{
		if (!isPixelStage && ClientPrefs.noteSplashes && note != null)
		{
